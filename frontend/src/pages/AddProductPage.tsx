...
const productSchema = z.object({
  ...
  quantity: z.coerce.number().int().min(0, "Quantity must be a valid number"),
...
const AddProductPage = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      costPrice: 0,
      sellingPrice: 0,
      lowStockThreshold: user?.defaultLowStockThreshold ?? 10,
    },
  });
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 text-body-sm text-muted-foreground mb-2">
        ...
        <span>›</span>
        <span className="label-caps text-[#1b1b1b]">Add Product</span>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-body-sm text-muted-foreground mb-6">
          Enter the essential tracking data for this stock item.
        </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  type="number"
                  placeholder={
                    user?.defaultLowStockThreshold?.toString() ?? "10"
                  }
                  step="1"
